...
\begin{align}
	Z(\xi) \equiv \int dx\, e^{\xi x} \, p(x) \  
	= \langle e^{\xi x}\rangle
	= \langle 1 \rangle + \xi\langle x\rangle
	+ \frac{1}{2}\xi^2 \langle x^2\rangle + \cdots \ ,
...
\begin{align}
	M_n =
	\left.\frac{\partial^n Z(\xi)}{\partial \xi^n}\right|_{\xi = 0} \ .
\end{align}
...
\begin{align}
	Z[q(t)] \sim \int \mathcal Dq(t) e^{i\int dt\, L} \ ,
\end{align}
...
\begin{align}
	Z[\varphi(x,t)] &= \int \mathcal D\varphi(x,t) e^{iS[\varphi]} \ 
	&
